...
<div class="row-fluid">
    ...
    <div class="span9">
        ...
        <fieldset>
            <g:form class="form-horizontal" action="edit" id="${communityScopeInstance?.id}">
                <g:hiddenField name="version" value="${communityScopeInstance?.version}"/>
                <fieldset>
                    <f:all bean="communityScopeInstance"/>
