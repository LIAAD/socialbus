 ...
 */
public class SocialechoWebserver implements Runnable{

    private ApplicationManager applicationManager;

    private static org.slf4j.Logger logger = LoggerFactory.getLogger(SocialechoWebserver.class);


    public SocialechoWebserver(ApplicationManager applicationManager){
...
//        }
        ...
        webConsoleRoute  .setExchangeName("socialecho-1");
