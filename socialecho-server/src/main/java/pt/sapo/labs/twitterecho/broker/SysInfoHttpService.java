...
public class SysInfoHttpService implements Processor {
    ...
    private SocialechoServerSessionStats twitterechoServerSessionStats;
...
//        HttpServletRequest req = exchange.getIn().getBody(HttpServletRequest.class);
        twitterechoServerSessionStats = SocialechoServerSessionStats.getInstance();
...
//        sysinfo.put("config.file",twitterechoServerSessionStats.getApplicationManager().getConfig().getProperty("config.file.path"));
        ...
        stats.put("services",twitterechoServerSessionStats.getServices());
