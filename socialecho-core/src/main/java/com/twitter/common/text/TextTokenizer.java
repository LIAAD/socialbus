...
public abstract class TextTokenizer {
  ...
  /**
   * Returns {@code TokenStream} to tokenize a com.twitter.common.text.
   *
   * @return {@code TokenStream} to tokenize the com.twitter.common.text
   */
   ...
   *
   * @param input com.twitter.common.text to be tokenized
