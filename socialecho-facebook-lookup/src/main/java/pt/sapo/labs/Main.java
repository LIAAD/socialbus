...
public class Main {
	...
	private static final String INPUT_FILE = "logback.xml";
...
//          Print all properties
            ...
            IApp app = new FacebookPageLookupApplication(config);
	...
	public static void main(String[] args)throws JoranException {
        ...
        basicConfigFile.setRequired(false);
    ...
    private static String loadVersion() {
        String userAgent = "Socialecho-Facebook-Lookup";
        try {
