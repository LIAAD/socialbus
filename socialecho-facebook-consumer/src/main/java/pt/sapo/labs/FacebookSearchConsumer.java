...
import pt.sapo.labs.adapters.MessageBrokerStatusAdapter;
...
public class FacebookSearchConsumer implements Runnable{
    ...
    private MessageBrokerStatusAdapter brokerAdapter;
    ...
    public FacebookSearchConsumer(CompositeConfiguration config){
        ...
        this.brokerAdapter = new MessageBrokerStatusAdapter(config,"search");
    }
...
//    }
    ...
    private void persistNewPost(JsonObject json, String searchTerm){
        ...
        this.brokerAdapter.onMessage(json.toString());
    }
}
