...
<div class="row-fluid">
    ...
    <div class="span9">
        ...
        <fieldset>
            <g:form class="form-horizontal" action="edit" id="${topicScopeInstance?.id}">
                <g:hiddenField name="version" value="${topicScopeInstance?.version}"/>
                <fieldset>
					
					<f:all bean="topicScopeInstance" except="twitterToken"/>
