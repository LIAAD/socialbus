...
'''
Version     :    0.1
Author      :    Marina Fouto / Robson Mafra / Arian Pasquali
Summary     :    This script checks if there are new data in Solr
'''
...
def send_email_alert(msg):
    ...
    _dest = ["arian@arianpasquali.com","arianpasquali@facebook.com"]
...
def itsnotok():
        msg = "WARNING: I couldn't find new messages on the lastest "+ str(cmd_options.interval) +" minutes"
        print msg
