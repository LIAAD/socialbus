...
/**
 * Reproduces the result of tokenization if an input com.twitter.common.text is an instance of
 * TokenizedCharSequence. Otherwise, passes the input com.twitter.common.text to downstream
 * TokenStream.
 */
public class TokenizedCharSequenceStream extends TokenProcessor {
  ...
  /**
   * Constructor.
   * If an input com.twitter.common.text is not tokenized (is not an instance of TokenizedCharSequence),
   * this uses inputStream to tokenize it.
   *
   * @param inputStream a token stream to tokenize a com.twitter.common.text if it's not tokenized yet.
   */
  ...
  /**
   * Constructor.
   * This can only accept an already-tokenized com.twitter.common.text (TokenzedCharSequence) as input.
   */
    ...
    super(new TokenStream() {
      ...
      public void reset(CharSequence input) {
        ...
        throw new IllegalArgumentException("Input must be an instance of TokenizedCharSequence"
                + " because there is no TokenStream in the downstream to tokenized a com.twitter.common.text.");
      }
    });
