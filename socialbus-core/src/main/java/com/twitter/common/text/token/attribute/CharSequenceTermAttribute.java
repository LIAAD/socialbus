 ...
 * {@link com.twitter.common.text.token.TokenStream#incrementToken()} is called. Instead, the offset and character length are
...
public interface CharSequenceTermAttribute extends Attribute {
   ...
   * {@link com.twitter.common.text.token.attribute.CharSequenceTermAttribute}.
   *
  ...
  /**
   * Returns the term com.twitter.common.text as a {@code CharSequence}, without needing to construct a
   * {@code String}. This method is preferred over {@link getTermString()}.
   *
   * @return {@code CharSequence} representing the term com.twitter.common.text.
   */
  CharSequence getTermCharSequence();

  /**
   * Returns the term com.twitter.common.text as a {@code String}.
   * {@link getTermCharSequence()} is preferred over this method.
   *
   * @return {@code String} representing the term com.twitter.common.text.
   */
