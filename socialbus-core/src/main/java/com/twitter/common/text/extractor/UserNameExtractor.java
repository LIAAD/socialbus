...
/**
 * Extracts user names ('@'+{username}) from com.twitter.common.text, according to the canonical definition found in
 * the {@code twitter-com.twitter.common.text-java} library {@link com.twitter.Regex}.
 */
