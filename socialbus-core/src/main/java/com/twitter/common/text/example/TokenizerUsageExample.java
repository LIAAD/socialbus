...
public class TokenizerUsageExample {
  ...
  public static void main(String[] args) {
    ...
    // can be understood as "annotations" on the original com.twitter.common.text.
    ...
    for (String tweet : famousTweets) {
      ...
      while (stream.incrementToken()) {
        // CharSequenceTermAttribute holds the actual token com.twitter.common.text. This is preferred over
