...
/**
 * Extracts entities from com.twitter.common.text according to a given regular expression.
 */
public class RegexExtractor extends TokenStream {
  ...
  /**
   * Sets a character that must appear in the input com.twitter.common.text. If a specified character does not appear
   * in the input com.twitter.common.text, this {@code RegexExtractor} does not extract entities from the com.twitter.common.text.
   * Specifying a {@code triggeringChar} may improve the performance by skipping unnecessary pattern
   * matching.
   *
   * @param triggeringChar a character that must appear in the com.twitter.common.text
   */
