...
import pt.sapo.labs.TwitterLookupService;
 ...
 */
public class TwitterLookupJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        twitterLookupService = new TwitterLookupService(config);
        twitterLookupService.run();
    }
}