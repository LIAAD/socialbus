...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.todo', 'sphinx.ext.pngmath', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode','sphinxcontrib.googleanalytics']
# Add any paths that contain templates here, relative to this directory.

# install google analytics plugin 
# https://pypi.python.org/pypi/sphinxcontrib-googleanalytics/
googleanalytics_id = 'UA-47346130-1'
...
html_theme_path = ['_themes/flask-sphinx-themes/flask']
