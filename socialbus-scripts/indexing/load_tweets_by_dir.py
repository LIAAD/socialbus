...
def readTweetsFromFile(fileName):
    ...
    if cmd_options.support_user_index:
        os.system("python "+ homeDir +"load_tweets_by_file.py -U -F " + fileName + " -S " + cmd_options.server_address)
    else:
        os.system("python "+ homeDir +"load_tweets_by_file.py -F " + fileName + " -S " + cmd_options.server_address)
