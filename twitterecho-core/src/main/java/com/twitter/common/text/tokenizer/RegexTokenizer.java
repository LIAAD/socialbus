...
/**
 * Tokenizes com.twitter.common.text based on regular expressions of word delimiters and punctuation characters.
 */
public class RegexTokenizer extends TokenStream {
  ...
  public abstract static class
     ...
     *
     * An input com.twitter.common.text is tokenized by the CharSequence
