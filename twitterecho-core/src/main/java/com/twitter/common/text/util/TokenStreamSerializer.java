...
public class TokenStreamSerializer {
   ...
   *
   * This method only deserializes all Attributes; the CharSequence instance containing the com.twitter.common.text
   * must be provided separately.
   * @param data  the byte-serialized representation of the tokenstream.
   * @param charSequence  the com.twitter.common.text that was tokenized.
