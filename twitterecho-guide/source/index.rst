...
How it works
------------
SocialEcho comprises three packages. SocialEcho Server, SocialEcho Twitter Consumer and SocialEcho Twitter OAuth.

SocialEcho Twitter Consumer are used to monitor and consume tweets from Twitter. Users can define which keywords or users they are interested in. Users can deploy as many consumers as wanted.
...
This documatation has all the instructions to deploy you own SocialEcho instance.
...
- `SocialEcho 0.5 <http://goo.gl/HwX0f5>`_
