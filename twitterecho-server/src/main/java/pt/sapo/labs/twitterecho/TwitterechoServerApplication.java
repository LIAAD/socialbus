...
import pt.sapo.labs.twitterecho.broker.TwitterechoWebserver;
...
public class TwitterechoServerApplication implements IApp {
	...
	public void start() {
        ...
        String clusterName = config.getString("cluster.name","twitterecho-1");
        ...
        TwitterechoWebserver twitterechoCamelRoutes = new TwitterechoWebserver(applicationManager);
        twitterechoCamelRoutes.setCamelContext(camelContext);

        Thread tcamel = new Thread(twitterechoCamelRoutes);
        tcamel.start();
